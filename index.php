                    ...
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="slider_text text-center">
                                <h3>Hotel Hebat</h3>
                                <p>Nikmati pemandangan Indah Alam</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="slider_text text-center">
                                ...
                                <p>Lepaskan semua kepenatan anda di Hotel Hebat</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-xl-5 col-lg-5">
                    <div class="about_info">
                        ...
                        <p>Lepaskan semua kepenatan dengan kenyamanan - kenyamanan yang sudah kami sediakan di hotel Yama. Nikmati kenikmatan sore yang sejuk dengan keindahan panorama pegunungan alam, sehingga hati kita nyaman dan tenang.
                        Hotel Yama menawarkan beragam fasilitas yang akan melengkapi kenyamanan keluarga.</p>
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> SMKN 1 Kota Cirebon|Rekayasa Perangkat Lunak by <a href="github.com/NajmiKhaeri" target="_blank">NajmiKAP</a>
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                    </div>
                        ...
                        <div class="popup_inner">
                            ...
                            <form >
                                <div class="row">
                                    ...
                                    <div class="col-xl-6">
                                        <input class="form-control" type="date" name ="cekin" placeholder="Check in date">
                                    </div>
                                    <div class="col-xl-6 mb-3">
                                        <input class="form-control" type="date" name = "cekout" placeholder="Check out date">
                                    </div>
                                    ...
                                    <div class="col-xl-12">
                                        <select class="form-select wide" name="room_tipe" id="default-select" class="">
                                            ...
                                            <option value="Exclusif">Exclusive Room</option>
